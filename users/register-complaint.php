...
$sql=mysqli_query($bd, "select * from users where id=$uid");
...
$query=mysqli_query($bd, "insert into tblcomplaints(userId,category,subcategory,complaintType,noc,complaintDetails,complaintFile,university,college,department) values('$uid','$category','$subcat','$complaintype','$noc','$complaintdetials','$compfile','$university','$college','$department')");
...
function getCat(val) {
 ...
 <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                      ...
                      <form class="form-horizontal style-form" method="post" onsubmit="return confirm('Are you sure you want to submit?');" name="complaint" enctype="multipart/form-data" >
...
<select name="noc" class="form-control">
