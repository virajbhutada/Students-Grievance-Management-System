...
$prn =$_POST['prn'];
$query=mysqli_query($bd, "update users set fullName='$fname',contactNo='$contactno',address='$address',State='$state',country='$country',pincode='$pincode',prn='$prn' where userEmail='".$_SESSION['login']."'");
if($query)
{
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">PRN/Enrollement Number</label>

<div class="col-sm-4">
<input type="text" name="prn" required="required" value="<?php echo htmlentities($row['prn']);?>" class="form-control" >
 </div>
<label class="col-sm-2 col-sm-2 control-label">university </label>
 <div class="col-sm-4">
<input type="email" name="university" required="required" value="<?php echo htmlentities($row['university']);?>" class="form-control" readonly>
</div>
 </div>
...
<div class="col-sm-4">
<input type="text" name="college" required="required" readonly="" value="<?php echo htmlentities($row['college']);?>" class="form-control" >
 </div>
<label class="col-sm-2 col-sm-2 control-label">Department</label>
 <div class="col-sm-4">
<input type="email" name="department" required="required" value="<?php echo htmlentities($row['department']);?>" class="form-control" readonly>
</div>
 </div>
...
<label class="col-sm-2 col-sm-2 control-label">Year</label>
 <div class="col-sm-4">
<input type="text" name="readonly" readonly="" required="required" value="<?php echo htmlentities($row['year']);?>" class="form-control" readonly>
</div>
...
<div class="col-sm-4">
<select name="state" required="required" class="form-control" readonly="">
