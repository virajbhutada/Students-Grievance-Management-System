...
{
$sql=mysqli_query($bd, "SELECT password FROM  college where password='".md5($_POST['password'])."' && email='".$_SESSION['alogin']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($bd, "update college set password='".md5($_POST['newpassword'])."', updationDate='$currentTime' where email='".$_SESSION['alogin']."'");
...
<head>
	...
	<title>College| Change Password</title>
