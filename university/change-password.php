...
if($num>0)
{
 $con=mysqli_query($bd, "update university set password='".md5($_POST['newpassword'])."', updationDate='$currentTime' where username='".$_SESSION['alogin']."'");
